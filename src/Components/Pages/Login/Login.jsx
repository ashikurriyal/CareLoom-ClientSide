    ...
    <div className="w-full max-w-md p-8 space-y-3 rounded-xl bg-base-200 text-gray-800 container mx-auto border-2 border-primary-cyan">
      ...
      <form onSubmit={handleLogin} className="space-y-6">
        <div className="space-y-1 text-sm">
          ...
          <input
            ...
            className="border-2 border-primary-cyan w-full px-4 py-3 rounded-md  bg-gray-50 text-gray-800 focus:border-fuchsia-700"
          />
        </div>
        <div className="space-y-1 text-sm">
          <label
          ...
          <input
            ...
            className="w-full px-4 py-3 rounded-md border-2 border-primary-cyan bg-gray-50 text-gray-800 focus:border-fuchsia-700"
          />
        </div>
        <button className="block w-full p-3 text-center text-lg font-normal shadow-xl rounded-sm text-white bg-primary-cyan hover:font-semibold">
          Sign in
        </button>
      </form>
      ...
      <div className="flex justify-center space-x-4">
        <button
          ...
          className="p-3 rounded-sm text-primary-cyan"
        >
          <svg
