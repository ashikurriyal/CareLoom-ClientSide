      ...
      <section className="bg-white dark:bg-gray-900">
        <div className="container px-6 py-12 mx-auto">
          <div className="text-center">
            ...
            <h1 className="text-2xl font-semibold md:text-3xl text-primary-cyan dark:text-white">
              Contact With Us
            </h1>
            ...
            <div className="mt-8 lg:w-1/2 lg:mx-6">
              <div className="w-full px-8 py-10 mx-auto overflow-hidden bg-white shadow-2xl rounded-xl dark:bg-gray-900 lg:max-w-xl">
                ...
                <form className="mt-4">
                  ...
                  <button className="w-full px-6 py-3 mt-6 text-sm font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-cyan-600 rounded-md hover:bg-cyan-700 focus:outline-none focus:ring focus:ring-cyan-400 focus:ring-opacity-50">
                    get in touch
                  </button>
                </form>
              </div>
